#### To run/view: please download data-visualisations.ipynb - it contains the interactive maps/charts. The jupyter notebook is too large to display.
...
The visualizations are in map, pie and line chart format. The map visualizations are at NUTS-3 and NUTS-4 level, making them more granular than the visualizations available on Eurostat.
